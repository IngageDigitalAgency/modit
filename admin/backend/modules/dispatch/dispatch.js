...
function showAddress(address, info, image, lat, lng) {
	...
	if (geocoder) {
		if (lat && lng && (lat != 0 && lng != 0)) {
			var e1 = `<a target="_d" href="/modit/dispatch/sameDays?order_id=184676&sameDays=1"><i class="fa fa-truck"></i></a>`;
			var e2 = `<a target = "_o" href="/modit/orders/showOrder?o_id=184676"><i class="fa fa-info-circle"></i></a>`;
	...
	if (geocoder) {
		if (address.latitude && address.longitude && (address.latitude != 0 && address.longitude != 0)) {
			if (address.sameDay == 1)
				var e1 = `<a target="_new" href="/modit/dispatch/sameDays?order_id=${address.order_id}&sameDays=1"><i class="fa fa-truck"></i></a>`;
			else
				var e1 = `<a target="_new" href="/modit/dispatch?order_id=${address.order_id}&overnights=1"><i class="fa fa-truck"></i></a>`;
			var e2 = `<a target = "_new" href="/modit/orders/showOrder?o_id=${address.order_id}"><i class="fa fa-info-circle"></i></a>`;
			//var a = "<a class='directions arrow' target='_new' href='http://maps.google.com/maps?f=d&hl=en&ie=UTF8&daddr=".concat(escape("(".concat(lat,",",lng,")"))).concat("'>Directions</a>");

...
$customerObj->Name = "Name" . random_int(1, 1000);
$customerObj->CompanyName = "CompanyName" . random_int(1, 1000);
$customerObj->GivenName = "GivenName" . random_int(1, 1000);
$customerObj->DisplayName = "DisplayName" . random_int(1, 1000);
...
//
$resultingCustomerObj->GivenName = "New Name " . random_int(1, 1000);

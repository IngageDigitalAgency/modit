...
class DataService {
     ...
     * @return Returns|string|null Returns an updated version of the entity with updated identifier and sync token.
     * @throws IdsException
     */
     ...
     * @return Returns|string|null Returns the created version of the entity.
     * @throws IdsException
     */
     ...
     * @return Returns|string|null Returns an array of entities fulfilling the query.
     * @throws IdsException
     */
     ...
     * @return ContentWriter|resource|string|type|null full path with filename or open handler
     */
     ...
     * @param int $pageSize
     * @return Returns|string|null Returns an array of entities of specified type.
     * @throws IdsException
     * @throws OAuthException
     */

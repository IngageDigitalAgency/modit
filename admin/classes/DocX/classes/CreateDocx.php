...
class CreateDocx extends CreateDocument
{
    ...
    public function addBackgroundImage($src)
    {
        ...
        $tempId = uniqid(random_int(999, 9999));
        $identifier = 'rId' . $tempId;

        // construct the background WordML code
        $this->_background = '<w:background w:color="' . $this->_backgroundColor . '">
                      <v:background id="id_' . uniqid(random_int(999, 9999)) . '" o:bwmode="white" o:targetscreensize="800,600">
                      <v:fill r:id="' . $identifier . '" o:title="tit_' . uniqid(random_int(999, 9999)) . '" recolor="t" type="frame" />
    ...
    public function addBookmark($options = array('type' => null, 'name' => null))
    {
        ...
        if ($type == 'start') {
            $bookmarkId = random_int(9999999, 999999999);
    ...
    {
        $class = get_class($this);
        $id = random_int(9999, 32766); //this number can not be bigger or equal than 32767
        $idBookmark = uniqid(random_int(999, 9999));
        ...
        if (isset($options['paraId'])) {
            ...
            $paraId = dechex(random_int(9, 999999));
        }
    ...
    public function addFooter($footers)
    {
        ...
        foreach ($footers as $key => $value) {
            if ($value instanceof WordFragment) {
                ...
                $newId = uniqid(random_int(999, 9999));
    ...
    public function addPageNumber($type = 'numerical', $options = array('defaultValue' => 1))
    {
        ...
        if ($type == 'page-of') {
            ...
            $pageNumber = str_replace(
                ...
                array(random_int(100000000, 999999999), random_int(100000000, 999999999), $options['pStyle'], $options['textAlign']),
                $pageNumber
            );
    ...
    public function addPermProtection($type)
    {
        ...
        if ($type == 'start') {
            // start protection
            self::$_protectionID = random_int(1111111111, 9999999999);
    ...
    public function createListStyle($name, $listOptions = array(), $listOverrideOptions = null)
    {
        ...
        $listId = random_int(9999, 999999999);
        ...
        if ($listOverrideOptions != null && is_array($listOverrideOptions)) {
            foreach ($listOverrideOptions as $listOverrideOption) {
                ...
                $listIdSub = random_int(9999, 999999999);
    ...
    public function enableTracking($options = array())
    {
        ...
        self::$trackingOptions['id'] = random_int(9999999, 99999999);
    }
                    ...
                    for ($j = $countrels; $j > -1; $j--) {
                        ...
                        switch ($myType) {
                            ...
                            case 'image':
                                ...
                                $refImage = 'media/image' . uniqid(random_int(999, 9999)) . '.' . $refExtension;
    ...
    public function importListStyle($path, $id, $name)
    {
        ...
        $listId = random_int(9999, 999999999);
        $originalAbstractNumId = random_int(9999, 999999999);
    ...
    public function importSingleNumbering($numberingsXML, $newNumbering, $numberId, $originalAbstractNumId = '', $removeNsid = false)
    {
        ...
        $newNumbering = str_replace('w:tplc=""', 'w:tplc="' . random_int(10000000, 99999999) . '"', $newNumbering);
    ...
    protected function generateCUSTOMRELS()
    {
        ...
        $strCustom = '<Relationship Id="rId' . random_int(999, 9999) . '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/custom-properties" Target="docProps/custom.xml" />';

...
<p stroke="0.2" fill="true" strokecolor="yellow" color="blue" style="font-family:helvetica, sans-serif;font-weight:bold;font-size:26pt;">You can set a full page background.</p>';

...
//                echo '<hr /><strong>Object</strong> reference is ', $n,'<br />';
//                var_dump($obj);
//                echo '<br />';
...
//                    echo '<strong>Cell annotation ', $note,'</strong><br />';
...
//        $recordData = $this->readRecordData($this->data, $this->pos + 4, $length);
    ...
    {
//        echo '<strong>Read Cell Annotation</strong><br />';
        $length = self::getInt2d($this->data, $this->pos + 2);
        $recordData = $this->readRecordData($this->data, $this->pos + 4, $length);
...
//        echo '<strong>_readTextObject()</strong><br />';
...
//        echo '<strong>_readObj()</strong><br />';
